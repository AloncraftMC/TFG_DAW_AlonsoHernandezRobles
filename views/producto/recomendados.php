...
<?php if (!empty($categorias)): ?>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            if (activeCategory) {
                let offsetLeft = activeCategory.parentElement.offsetLeft; // Obtener la posición de la categoría activa
                carousel.style.scrollBehavior = "auto"; // Deshabilitar animación de scroll
